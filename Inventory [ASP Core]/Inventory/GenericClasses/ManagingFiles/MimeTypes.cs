...
namespace Inventory.GenericClasses.ManagingFiles
{
    ...
    public class MimeTypes
    {
        ...
        // This Class is responsible for reading file bytes and return the actual mime type of file Even if the file name and extension were changed by hacked user
